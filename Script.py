...
‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/Indian_boy_jk'>boss jk</a> 
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/bot_updaterr)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/Indian_boy_jk>☢boss☢</a></b>
  
 <b>✯ Join here : <a href=https://t.me/jk_movie_adda>☢Join my updateds☢</a></b> 
...
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ?"""
    ...
    I_CUDNT = """<b>sᴏʀʀʏ ɴᴏ ꜰɪʟᴇs ᴡᴇʀᴇ ꜰᴏᴜɴᴅ ꜰᴏʀ ʏᴏᴜʀ ʀᴇǫᴜᴇꜱᴛ आपका मोव्ही नहीं है हमारे डाटाबेस मैं । {} 😕

ᴄʜᴇᴄᴋ ʏᴏᴜʀ sᴘᴇʟʟɪɴɢ ɪɴ ɢᴏᴏɢʟᴇ ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ आपका स्पेलिंग गलत है 😃

ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇꜱᴛ ꜰᴏʀᴍᴀᴛ इस तरह सर्च करो । 👇

ᴇxᴀᴍᴘʟᴇ उदा  : pushpa or animal 2024 or Uncharted En
...
ɪꜰ ʏᴏᴜ ᴅᴏ ɴᴏᴛ ꜱᴇᴇ ᴛʜᴇ ʀᴇǫᴜᴇsᴛᴇᴅ ᴍᴏᴠɪᴇ / sᴇʀɪᴇs ꜰɪʟᴇ, ʟᴏᴏᴋ ᴀᴛ ᴛʜᴇ ɴᴇxᴛ ᴘᴀɢᴇ"""
    ...
    SINFO = """
🫣 For Movie Join First Then Click On Try Again Button पहले ज्वाइन करो फिर Try पर क्लिक करो 😅"""
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த Jkmovie_searchr_bot போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்

 படி 2: உங்கள் இணையதளம் மற்றும் API ஐச் சேர்க்கவும்

 Exp: /shortlink https://publicearn.com/ref/Bossjk
...
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 Step 1: Administer this Jkmovie_searchr_bot bot to your group
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ Jkmovie_searchr_bot బాట్‌ని మీ సమూహానికి నిర్వహించండి

 దశ 2: మీ వెబ్‌సైట్ మరియు APIని జోడించండి

 గడువు: /shortlink https://publicearn.com/ref/Bossjk
...
अरे <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 चरण 1: इस फ़िल्टर-बॉट बॉट को अपने समूह में प्रशासित admin करें

 चरण 2: अपनी वेबसाइट और एपीआई जोड़ें
 चरण 3: ऐसे जोडे example  publicearn.com vshsnjksbsbhkb
 चरण 4: अगर आपके पास कोई साईट नहीं है । तो निचे दिए गए लिंक से अकाऊंट बनाएँ
 चरण 5: /शॉर्टलिंक site  https://publicearn.com/ref/Bossjk
...
ഹേയ് <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 കാലഹരണപ്പെടൽ: /https://publicearn.com/ref/Bossjk
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس Jkmovie_searchr_bot بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ Jkmovie_searchr_bot બોટનું સંચાલન કરો

 પગલું 2: તમારી વેબસાઇટ અને API ઉમેરો

 સમાપ્તિ: /shortlink https://publicearn.com/ref/Bossjk
 વિડિઓ ઉમેરો
...
ಹೇ {message.from_user.mention}
 ...
 ಅವಧಿ: /shortlink https://publicearn.com/ref/Bossjk
 ವೀಡಿಯೊ ಸೇರಿಸಿ
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই Jkmovie_searchr_bot বট পরিচালনা করুন

 ধাপ 2: আপনার ওয়েবসাইট এবং API যোগ করুন

 মেয়াদ: /shortlink https://publicearn.com/ref/Bossjk
 একটি ভিডিও যোগ করুন
...
-Dev 1 [Owner of this bot ]<a href='https://t.me/Indian_boy_jk'>owner</a>

-Dev 2 <a href='https://t.me/Indian_boy_jk'>jk</a>

-Dev 3 <a href='https://t.me/Indian_boy_jk>jk Botz</a>

- Dev 4 <a href='https://t.me/Indian_boy_jk'>TEAM jk</a>
"""
...
# Don't Remove Credit @jk_movie_adda
# Subscribe YouTube Channel For Amazing Bot @jk_movie_adda
# Ask Doubt on telegram @Indian_boy_jk
