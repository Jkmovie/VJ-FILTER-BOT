...
PICS = (environ.get('PICS', 'https://envs.sh/94M.jpg https://envs.sh/94y.jpg')).split()
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002231288421')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001592581398')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vikramvanjara83851:BNPM2WVY9YANm8mt@cluster0.soyoe.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
